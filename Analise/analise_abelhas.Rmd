...
subtitle: "Estrutura da Paisagem (proporção de habitat natural x heterogeneidade) e Composição de Espécies"
author: "Cinthia Soares Noves"
...
- **PERMANOVA**: Teste de efeito de variáveis ambientais na composição
- **ANOSIM**: Diferenças entre grupos (contextos e locais)
...
# Modelo 1: Variáveis ambientais contínuas
...
# Modelo 4: Bloqueado por Local (controla pseudorreplicação)
...
cat("\n--- PERMANOVA: + Contexto ---\n")
print(perm2)
cat("\n--- PERMANOVA: Com Interação ---\n")
print(perm3)
cat("\n--- PERMANOVA BLOQUEADA por Local (RECOMENDADO) ---\n")
print(perm_blocked)
```

**Interpretação:** A PERMANOVA testa se as variáveis ambientais explicam diferenças na composição de espécies. O R² indica a proporção da variância explicada. O modelo bloqueado controla a pseudorreplicação dos pontos dentro de cada local.
...
Este documento apresentou uma análise completa das comunidades de abelhas do Cerrado, incluindo:
...
- **PERMANOVA** confirmou o efeito significativo das variáveis ambientais na composição
- **ANOSIM** mostrou diferenças significativas entre bordas urbanas e zonas rurais (R = `r round(anosim_contexto$statistic, 3)`, p = `r anosim_contexto$signif`)
...
✅ **Controle de Pseudorreplicação**: Uso de GLMM e PERMANOVA bloqueada  
...
**Repositório GitHub:** [Adicione o link aqui quando criar]
